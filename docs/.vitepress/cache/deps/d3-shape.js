...
function arc_default() {
  ...
  arc.innerRadius = function (_) {
    return arguments.length
      ? ((innerRadius = typeof _ === 'function' ? _ : constant_default(+_)),
        arc)
      : innerRadius
  }
  arc.outerRadius = function (_) {
    return arguments.length
      ? ((outerRadius = typeof _ === 'function' ? _ : constant_default(+_)),
        arc)
      : outerRadius
  }
  arc.cornerRadius = function (_) {
    return arguments.length
      ? ((cornerRadius = typeof _ === 'function' ? _ : constant_default(+_)),
        arc)
      : cornerRadius
  }
